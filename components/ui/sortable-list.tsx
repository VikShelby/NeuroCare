      ...
      <div className="flex w-full items-center mb-3">
        <Reorder.Item
          ...
          className={cn(
            ...
            "h-full rounded-xl bg-primary-foreground",
                  ...
                  >
                    ...
                    <div className="pl-3 pt-1">
                      <Checkbox
                        ...
                        className="  h-5 w-5 rounded-md border-1 bg-black/30 data-[state=checked]:bg-black data-[state=checked]:text-red-200"
                      />
                    </div>
                    {/* List Order */}
                    <p className="font-mono text-xs pl-1 text-black">
                      {order + 1}
                    </p>
                    ...
                    >
                      <h4
                        className={cn(
                          "tracking-tighter text-[#303030] md:text-lg ",
                          item.checked ? "text-red-400" : "text-[#303030]"
                        )}
                      >
